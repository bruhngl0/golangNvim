...
/*DEFER-------
  ...
  Basically pushing the execution of a function to the last statement and ensuring that it always runs
  and it doesnot matter if the function is successful/errors out or not. it is a very iportant concept and should be used alot
